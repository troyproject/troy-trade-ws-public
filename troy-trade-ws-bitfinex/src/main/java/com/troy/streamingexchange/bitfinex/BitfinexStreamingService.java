...
import com.troy.streamingexchange.bitfinex.dto.BitfinexWebSocketSubscriptionMessage;
import com.troy.streamingexchange.bitfinex.dto.BitfinexWebSocketUnSubscriptionMessage;
...
public class BitfinexStreamingService extends JsonNettyStreamingService {
    ...
    public String getSubscribeMessage(String channelName, Object... args) throws IOException {
        ...
        if (args.length == 1) {
            ...
            LOG.info("bitfinex 调用getSubscribeMessage()方法参数{},{},{},{},{}",channelName, (String) args[0], (String) args[1],
