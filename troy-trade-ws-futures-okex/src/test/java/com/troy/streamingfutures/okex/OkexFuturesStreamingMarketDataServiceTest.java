...
public class OkexFuturesStreamingMarketDataServiceTest {

    @Mock
    private OkexFuturesStreamingService okexStreamingService;
    private OkexFuturesStreamingMarketDataService marketDataService;

    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
        marketDataService = new OkexFuturesStreamingMarketDataService(okexStreamingService);
    }
