...
public class HuobiFuturesOrderbookTest {

    @Test
    public void timestampShouldBeInSeconds() {
        HuobiFuturesOrderbook depth = new HuobiFuturesOrderbook();
...
//                );
        ...
        String exchangeClassName = HuobiFuturesStreamingExchange.class.getName();
