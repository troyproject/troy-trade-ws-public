...
import static com.troy.streamingexchange.binance.dto.BaseBinanceWebSocketTransaction.BinanceWebSocketTypes.TICKER_24_HR;
...
public class TickerBinanceWebsocketTransactionTest {
    ...
    public void test_deserialization_of_transaction_message() throws IOException {
        ...
        assertThat(tickerTransaction.getCurrencyPair()).isEqualTo(currencyPair);
